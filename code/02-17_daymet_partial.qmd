...
Ans: 254,770 rows after using pivot_wider, initially it was more than 1,000,000 rows with less columns. Now columns are more, rows are less whic makes easier in calculation.
...
**Find open source data APIs for poultry**
